...
This paper focuses on synthesizing verifiable reasoning data at scale for learning logical reasoning and beyond. Junteng Liu is the first author. The work has an associated GitHub code repository.
